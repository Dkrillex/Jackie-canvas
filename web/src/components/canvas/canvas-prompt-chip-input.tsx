...
export function CanvasPromptChipInput({ value, references, onChange, onSubmit, className, style, placeholder }: Props) {
    ...
    return (
        <div className="relative w-full">
            ...
            {imagePreview ? <Image src={imagePreview} alt="Referenced image preview" style={{ display: "none" }} preview={{ visible: true, src: imagePreview, onVisibleChange: (visible) => !visible && setImagePreview(null) }} /> : null}
        </div>
    );
}
