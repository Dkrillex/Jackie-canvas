        ...
        <div className="absolute bottom-5 left-5 z-50" onMouseDown={(event) => event.stopPropagation()} onPointerDown={(event) => event.stopPropagation()}>
            ...
            <Modal title={t("canvas.shortcuts")} open={shortcutsOpen} onCancel={() => setShortcutsOpen(false)} footer={null} centered>
                <div className="space-y-3 border-t pt-4 text-sm" style={{ borderColor: theme.node.stroke }}>
                    <Shortcut label={t("canvas.shortcut.pan")} value={t("canvas.shortcut.panValue")} />
                    <Shortcut label={t("canvas.shortcut.wheel")} value={t("canvas.shortcut.wheelValue")} />
                    <Shortcut label={t("canvas.shortcut.box")} value={t("canvas.shortcut.boxValue")} />
                    <Shortcut label={t("canvas.shortcut.add")} value={t("canvas.shortcut.addValue")} />
                    <Shortcut label={t("canvas.shortcut.copy")} value={t("canvas.shortcut.copyValue")} />
                    <Shortcut label={t("canvas.shortcut.delete")} value={t("canvas.shortcut.deleteValue")} />
                </div>
            </Modal>
        </div>
    );
