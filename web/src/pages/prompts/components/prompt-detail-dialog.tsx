                    ...
                    <>
                        <div className="grid gap-5 md:grid-cols-[300px_minmax(0,1fr)]">
                            ...
                            <div className="min-w-0">
                                ...
                                {prompt.createdAt || prompt.updatedAt ? <div className="mt-4 text-xs text-stone-500 dark:text-stone-400">{prompt.createdAt ? t("prompts.created", { date: formatPromptDate(prompt.createdAt) }) : null}{prompt.createdAt && prompt.updatedAt ? " · " : null}{prompt.updatedAt ? t("prompts.updated", { date: formatPromptDate(prompt.updatedAt) }) : null}</div> : null}
