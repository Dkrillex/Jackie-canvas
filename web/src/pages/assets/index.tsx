...
export default function AssetsPage() {
    ...
    return (
        <div className="flex h-full flex-col overflow-hidden tennda-page-bg text-foreground">
            <main data-app-page-scroll className="min-h-0 flex-1 overflow-y-auto px-6 py-8">
                <div className="pb-8">
                    <div className="mx-auto max-w-6xl">
                        <div className="font-mono text-[11px] tracking-[0.18em] text-muted-foreground uppercase">Library · Assets</div>
                        <h1 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">{t("page.assetsTitle")}</h1>
                        <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">{t("page.assetsDesc")}</p>
                    </div>
                    ...
                    <div className="mx-auto mt-6 grid max-w-6xl gap-3 text-left">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <div className="grid gap-2 sm:grid-cols-[56px_minmax(0,1fr)] sm:items-center">
                                <div className="text-xs font-medium text-muted-foreground dark:text-muted-foreground">{t("common.type")}</div>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <button
                                    type="button"
                                    className="cursor-pointer text-sm font-medium text-foreground/80 underline-offset-4 hover:underline focus-visible:outline-none focus-visible:underline dark:text-muted-foreground"
            ...
            <Modal title={editingAsset ? t("assets.edit") : t("assets.add")} open={isAssetOpen} width={980} onCancel={() => setIsAssetOpen(false)} onOk={() => void saveAsset()} okText={t("action.save")} cancelText={t("action.cancel")} destroyOnHidden>
                <div className="grid gap-6 pt-1 lg:grid-cols-[minmax(0,1fr)_320px]">
                    ...
                    <div className="rounded-xl border border-border bg-muted/70 p-4 dark:border-border dark:bg-card">
                        <Typography.Text strong>{t("common.preview")}</Typography.Text>
                        <div className="mt-3 overflow-hidden rounded-lg border border-border bg-background dark:border-border">
                            {coverUrl || imageDraft?.dataUrl ? (
                                <img src={coverUrl || imageDraft?.dataUrl} alt="" className="aspect-[4/3] w-full object-cover" />
                            ) : (
                                <div className="flex aspect-[4/3] items-center justify-center bg-muted p-5 text-center text-sm text-muted-foreground dark:bg-muted">{content || t("common.noCover")}</div>
                            )}
                            <div className="p-4">
            ...
            cover={
                <button type="button" className="block w-full text-left" onClick={onOpen}>
                    {cover ? (
                        ...
                        <div className="flex aspect-[4/3] items-center justify-center bg-muted p-5 text-center text-sm leading-6 text-muted-foreground dark:bg-muted dark:text-muted-foreground">{asset.kind === "text" ? asset.data.content : t("common.noCover")}</div>
                    )}
                </button>
            }
        >
                ...
                <div className="p-4">
                    <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                            <h2 className="line-clamp-1 text-sm font-semibold text-foreground dark:text-foreground">{asset.title}</h2>
            ...
            {asset ? (
                <div className="space-y-5">
                    {cover ? (
                        ...
                        <div className="rounded-lg border border-border bg-muted/70 p-5 text-sm leading-6 text-muted-foreground dark:border-border dark:bg-muted dark:text-muted-foreground">{asset.kind === "text" ? asset.data.content : t("common.noCover")}</div>
                    )}
                    <div>
