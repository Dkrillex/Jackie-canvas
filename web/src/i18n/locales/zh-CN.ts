export default {
    meta: {
        title: "Jackie Canvas",
        description: "Jackie Canvas 创作工具",
    },
    theme: { toggle: "切换主题" },
    login: {
        title: "登录 Jackie Canvas",
        username: "用户名",
        password: "密码",
    ...
    seedance: {
        ...
        referenceHint: "参考视频需为 mp4/mov，H.264/H.265，FPS 24-60；可为公网 https / asset://；本地文件需先在配置中填写对象存储 AccessKey，生成时会自动上传；含真人人脸资产请使用火山授权 asset:// 资产。",
        errors: {
            ...
            invalid: "{{label}} 无效，请重新上传",
            needsPublicOrOss: "{{label}} 需公网 https / asset://，或先在配置中填写对象存储 AccessKey 后再上传本地文件",
            cloudPending: "{{label}} 仍在处理中，请等待素材变为可用后再生成",
            cloudFailed: "{{label}} 素材处理失败，请重新上传",
            cloudMixedGroups: "同一次 Seedance 生成只能使用同一素材组中的云素材，请调整连线后再试",
            cloudMissingGroup: "云素材缺少素材组信息，请从侧栏 Seedance 素材库重新添加到画布",
        },
    },
    modelPlugin: {
    ...
    canvas: {
        ...
        export: { defaultProjectName: "Jackie Canvas", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
        ...
        assets: { local: "本地", seedance: "Seedance 素材库" },
        seedance: {
            loadFailed: "加载 Seedance 素材库失败",
            groupNameRequired: "请输入素材组名称",
            groupCreated: "素材组已创建",
            groupCreateFailed: "创建素材组失败",
            groupDeleted: "素材组已删除",
            groupDeleteFailed: "删除素材组失败",
            uploading: "正在上传并处理素材…",
            uploadDone: "已上传 {{count}} 个素材",
            uploadUnsupported: "仅支持图片 / mp4·mov 视频 / mp3·wav 音频",
            uploadFailed: "上传素材失败",
            notActive: "素材尚未就绪，请等待处理完成后再添加",
            added: "已添加",
            noPreview: "云素材（无预览，可用于生成）",
            assetDeleted: "素材已删除",
            assetDeleteFailed: "删除素材失败",
            selectGroup: "选择素材组",
            newGroup: "新建素材组",
            deleteGroup: "删除素材组",
            deleteGroupConfirm: "确定删除当前素材组？组内素材将一并删除。",
            refresh: "刷新",
            upload: "上传",
            empty: "当前素材组暂无素材",
            groupNamePh: "素材组名称",
    ...
    jobs: {
        ...
        walletSummary: "余额 {{balance}} · 冻结 {{frozen}} · 可用 {{available}} credits",
        goRecharge: "去充值",
        refresh: "刷新",
        ...
        notFound: "工作不存在",
        fieldTitle: "标题",
        fieldBrief: "工作内容要求（Markdown）",
        fieldBudget: "预算（credits）",
        briefWrite: "编辑",
        briefPreview: "预览",
        briefPlaceholder: "支持 Markdown：标题、列表、链接等。点右上角可插入图片。",
        briefHint: "图片会插入为 Markdown 图片语法，保存在本机；预览可查看渲染效果。",
        briefEmptyPreview: "暂无内容可预览",
        briefRequired: "请填写工作内容要求",
        uploadImage: "插入图片",
        imageUploaded: "图片已插入",
        ...
        acceptQuoteAmount: "接受报价 {{amount}}",
        quoteAccepted: "已接受报价并冻结积分",
        submitDelivery: "提交交付",
        deliveryContent: "交付说明",
        deliveryLink: "交付链接",
        deliveryCanvas: "关联画布 ID",
        deliverySubmitted: "交付已提交",
        acceptDelivery: "验收通过并结算",
        rejectDelivery: "驳回修改",
        rejectReason: "驳回原因",
        rejectDefault: "请按要求修改后重提",
        rejected: "已驳回，等待重新提交",
        costAmount: "实际成本（AI/外采等）",
        settlePreview: "平台费 {{fee}} · 创作者到手 {{payout}} · 利润 {{profit}}",
        settled: "已验收并结算",
        cancel: "取消工作",
        cancelled: "工作已取消",
        insufficient: "可用积分不足，请先充值",
        actionFailed: "操作失败",
        quotes: "报价列表",
        noNote: "无说明",
        acceptedQuote: "成交报价",
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>Jackie Canvas</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    config: {
        ...
        account: {
            ...
            balanceLeft: "剩余金额",
            apiKey: "当前密钥",
            apiKeyHint: "登录后自动同步平台 auto 分组启用密钥",
            apiKeyEmpty: "暂无 auto 密钥",
            apiKeyCopied: "密钥已复制",
            goLogin: "去登录",
            loggedInHint: "已登录，可查看余额并退出。",
            loggedOutHint: "登录后可查看账号与剩余金额。",
            loading: "加载中...",
            empty: "暂无",
            unlimited: "无限制",
            sessionExpired: "会话已失效，请重新登录",
            loginOrChannelHint: "请先登录，或在渠道里填写 Base URL 和 API Key",
        ...
        localStorage: {
            ...
            description: "查看 Jackie Canvas 在浏览器中保存的数据量，并按对象仓库统计内容体积。",
            ...
            mainDatabase: "Jackie Canvas 主数据",
            records: "{{count}} 条",
            refresh: "刷新统计",
            readFailed: "读取本地存储失败",
