export default {
    meta: {
        title: "Jackie Canvas",
        description: "Jackie Canvas creation tool",
    },
    theme: { toggle: "Toggle theme" },
    login: {
        title: "Sign in to Jackie Canvas",
        username: "Username",
        password: "Password",
        ...
        actionRequired: "Please sign in before generating",
    },
    common: {
        cancel: "Cancel",
        save: "Save",
    ...
    seedance: {
        ...
        referenceHint: "Reference videos must be mp4/mov, H.264/H.265, and 24–60 FPS. Public https / asset:// are accepted; local files require object-storage AccessKeys in settings and are uploaded automatically at generation time. Use authorized Volcengine asset:// assets when real faces are included.",
        errors: {
            ...
            invalid: "{{label}} is invalid. Upload it again.",
            needsPublicOrOss: "{{label}} needs a public https / asset:// URL, or configure object-storage AccessKeys before uploading local files",
            cloudPending: "{{label}} is still processing. Wait until the asset is ready before generating",
            cloudFailed: "{{label}} failed processing. Upload it again",
            cloudMixedGroups: "A single Seedance generation can only use cloud assets from the same asset group. Adjust connections and try again",
            cloudMissingGroup: "Cloud assets are missing group info. Re-add them from the Seedance library in the side panel",
        },
    },
    modelPlugin: {
    ...
    videoWorkbench: {
        ...
        seedanceLibrary: "Seedance library",
    },
    canvas: {
        defaultTitle: "Jackie Canvas {{count}}",
        ...
        export: { defaultProjectName: "Jackie Canvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
        ...
        assets: {
            local: "Local",
            seedance: "Seedance library",
        },
        seedance: {
            loadFailed: "Failed to load Seedance asset library",
            groupNameRequired: "Enter an asset group name",
            groupCreated: "Asset group created",
            groupCreateFailed: "Failed to create asset group",
            groupDeleted: "Asset group deleted",
            groupDeleteFailed: "Failed to delete asset group",
            uploading: "Uploading and processing assets…",
            uploadDone: "Uploaded {{count}} assets",
            uploadUnsupported: "Only images / mp4·mov video / mp3·wav audio are supported",
            uploadFailed: "Failed to upload asset",
            notActive: "Asset is not ready yet. Wait until processing finishes.",
            added: "Added",
            noPreview: "Cloud asset (no preview, usable for generation)",
            assetDeleted: "Asset deleted",
            assetDeleteFailed: "Failed to delete asset",
            selectGroup: "Select asset group",
            newGroup: "New asset group",
            deleteGroup: "Delete asset group",
            deleteGroupConfirm: "Delete this asset group? Assets in the group will also be removed.",
            refresh: "Refresh",
            upload: "Upload",
            empty: "No assets in this group",
            groupNamePh: "Asset group name",
            statusActive: "Active",
    ...
    jobs: {
        ...
        walletSummary: "Balance {{balance}} · Frozen {{frozen}} · Available {{available}} credits",
        goRecharge: "Top up",
        refresh: "Refresh",
        ...
        fieldTitle: "Title",
        fieldBrief: "Requirements (Markdown)",
        fieldBudget: "Budget (credits)",
        briefWrite: "Write",
        briefPreview: "Preview",
        briefPlaceholder: "Markdown supported: headings, lists, links, etc. Use the button to insert images.",
        briefHint: "Images are inserted as Markdown and stored locally; switch to Preview to render.",
        briefEmptyPreview: "Nothing to preview",
        briefRequired: "Please enter requirements",
        ...
        acceptQuoteAmount: "Accept {{amount}}",
        quoteAccepted: "Quote accepted and credits frozen",
        submitDelivery: "Submit delivery",
        deliveryContent: "Delivery notes",
        deliveryLink: "Delivery link",
        deliveryCanvas: "Linked canvas ID",
        deliverySubmitted: "Delivery submitted",
        acceptDelivery: "Accept & settle",
        rejectDelivery: "Request changes",
        rejectReason: "Reason",
        rejectDefault: "Please revise and resubmit",
        rejected: "Rejected — waiting for resubmit",
        costAmount: "Actual cost (AI / ops)",
        settlePreview: "Fee {{fee}} · Creator payout {{payout}} · Profit {{profit}}",
        settled: "Accepted and settled",
        cancel: "Cancel job",
        cancelled: "Job cancelled",
        insufficient: "Not enough available credits",
        actionFailed: "Action failed",
        quotes: "Quotes",
        noNote: "No note",
        acceptedQuote: "Accepted quote",
        delivery: "Delivery",
        openCanvas: "Open linked canvas",
        lastReject: "Last rejection",
        settlement: "Settlement",
        settleQuote: "Quote credits",
        settleFee: "Platform fee",
        settlePayout: "Creator payout",
        settleCost: "Actual cost",
        settleProfit: "Profit (fee − cost)",
        ledgerTime: "Time",
        ledgerKind: "Type",
        ledgerAmount: "Amount",
        ledgerNote: "Note",
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>Jackie Canvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    config: {
        ...
        account: {
            title: "Account info",
            name: "Account",
            balanceLeft: "Balance remaining",
            apiKey: "API key",
            apiKeyHint: "Synced from your enabled auto-group key after sign-in",
            apiKeyEmpty: "No auto-group key",
            apiKeyCopied: "API key copied",
            goLogin: "Sign in",
            loggedInHint: "Signed in. You can check your balance and sign out.",
            loggedOutHint: "Sign in to view your account and remaining balance.",
            loading: "Loading...",
            empty: "N/A",
            unlimited: "Unlimited",
            sessionExpired: "Session expired — please sign in again",
            loginOrChannelHint: "Sign in, or fill Base URL and API Key in a channel",
            fetchFailed: "Failed to load account info",
            logout: "Sign out",
        ...
        localStorage: {
            ...
            description: "View browser data saved by Jackie Canvas, grouped by object store.",
            ...
            mainDatabase: "Jackie Canvas data",
