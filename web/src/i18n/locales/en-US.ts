export default {
    ...
    jobs: {
        title: "Jobs",
        subtitle: "Frontend demo: recharge → post/quote → deliver → accept → settle (1 credit = $1, local mock only).",
        roleClient: "I am client",
        roleCreator: "I am creator",
        resetDemo: "Reset demo data",
        resetDone: "Demo data reset",
        walletSummary: "Balance {{balance}} · Frozen {{frozen}} · Available {{available}} credits",
        mockRecharge: "Mock recharge",
        create: "Post a job",
        created: "Job posted",
        recharged: "Recharged",
        invalidAmount: "Enter a valid amount",
        creditHint: "1 credit = 1 USD. Local mock only — no real payment.",
        tabHall: "Open jobs",
        tabMine: "My jobs",
        tabWallet: "Ledger",
        empty: "No jobs yet",
