<p align="center">
  <img src="web/public/logo.svg" width="96" alt="Illucent AI logo">
</p>
...
- 本地 Agent：通过本机 Canvas Agent 连接 Codex / WorkBuddy / Claude Code，让 Agent 通过 MCP 操作当前画布；
- Codex / WorkBuddy 插件：同一插件目录同时支持 Codex 与 WorkBuddy，安装后会注册 MCP 并尝试拉起本地 Agent。
