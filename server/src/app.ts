...
import { alipayConfigured, mysqlConfigured, novaApiMysqlConfigured, settings } from "./config.js";
...
app.get("/health", (c) => c.json({ ok: true, alipay: alipayConfigured(), mysql: mysqlConfigured(), novaApi: novaApiMysqlConfigured() }));
